...
namespace DevionGames
{
	...
	public static class EditorTools
	{
		...
		public static bool Titlebar(string hash, GUIContent content, object target, GenericMenu menu)
		{
			...
			Rect rect = new Rect(position.x + Styles.inspectorTitle.padding.left, position.y + Styles.inspectorTitle.padding.top, 16f, 16f);
			Rect rect1 = new Rect(position.xMax - Styles.inspectorTitle.padding.right - 2f - 16f, rect.y, 16f, 16f);
			Rect rect4 = rect1;
			rect4.x = rect4.x - 18f;
