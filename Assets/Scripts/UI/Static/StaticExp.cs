...
public class StaticExp : BaseScript
{
	...
	private bool m_NeedShowAbility; // 레벨업 후 어빌리티 창을 띄워야 할 때
	...
	public bool NeedShowAbility => m_NeedShowAbility;
	...
	private IEnumerator UpdateExpBar()
	{
		...
		while (!StageManager.IsPlayerDeath)
		{
			...
			m_NeedShowAbility = m_Exp >= m_ExpMax ? true : false;
