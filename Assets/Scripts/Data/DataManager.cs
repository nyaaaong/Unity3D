...
public class DataManager : Singleton<DataManager>
{
	...
	public static int GetBuffPercent(Ability_Type buff, bool isEnhanced)
	{
		...
		return Mathf.RoundToInt(Inst.m_BuffData[idx].Multiplier * value) * 100 - 100; // float값을 int로 바꿔주면서 퍼센트로 바꿔준다
	}
	...
	public static void AddBuffPercent(Ability_Type buff, float value)
	{
		...
		Inst.m_BuffData[(int)buff].Percent = Mathf.RoundToInt(Inst.m_BuffData[idx].Multiplier) * 100 - 100;
